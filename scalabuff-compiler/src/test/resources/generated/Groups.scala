...
object Groups {
	...
	def parse(message: Array[Byte]): Groups = defaultInstance.mergeFrom(message)
	def parse(message: com.google.protobuf.ByteString): Groups = defaultInstance.mergeFrom(message)
